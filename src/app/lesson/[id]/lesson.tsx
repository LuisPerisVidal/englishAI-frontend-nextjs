		...
		<div className="bg-slate-100">
			<div className="mx-auto max-w-3xl pt-5 pb-5">
				...
				<h2 className="text-2xl font-bold">Tenses</h2>
					{state.info && state.info.tenses &&
					state.info.tenses.join(", ")}
				...
				<h2 className="text-2xl font-bold mt-4">Exercises:</h2>
					{state.info && state.info.lesson &&
						<div>{state.info.lesson.map((l, index)=> <Sentence key={index} sentence={l.sentence} solution={l.solution} verb={l.verb} />)}</div>}
